# Generated by Django 3.2.25 on 2025-02-27 09:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('wechat', '微信'), ('qq', 'QQ'), ('weibo', '微博'), ('alipay', '支付宝'), ('dingtalk', '钉钉'), ('apple', '苹果'), ('google', '谷歌'), ('facebook', '脸书'), ('twitter', '推特'), ('github', 'GitHub'), ('linkedin', '领英')], max_length=20, unique=True, verbose_name='名称')),
                ...
                ('redirect_uri', models.URLField(verbose_name='回调URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('provider_user_id', models.CharField(max_length=255, verbose_name='第三方用户ID')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.oauthprovider')),
            ...
            options={
                'verbose_name': '用户OAuth账号',
                'verbose_name_plural': '用户OAuth账号',
